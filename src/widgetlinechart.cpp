 ...
 * @brief WidgetLineChart::WidgetLineChart Specified constructor
 * @param parent chosen parent -- the display window object
 * @param meas  active measure
 * @param range chosen range
 */
WidgetLineChart::WidgetLineChart(QWidget *parent, const Measure &meas, const std::pair<double, double> &range):QWidget(parent),ui(new Ui::WidgetLineChart),_meas(new Measure(meas)), _currentTemp(new GraphTemplate())
{
    ui->setupUi(this);
    _range = range;
...
/**
 * @brief Draw a line graph using the selected years and Municipalities
...
/**
 * @brief Draw a line graph using the selected years and Municipalities and plots everything back to default.
 * @param lowrange the low range of the data
 * @param highrange the high range of the data
 */
void WidgetLineChart::drawChartDefault()
{
    ...
    ui->widgetLineChart_2->legend->setBrush(QBrush(Qt::white));
    ui->widgetLineChart_2->axisRect()->insetLayout()->setInsetAlignment(0, Qt::AlignRight|Qt::AlignTop);
...
void WidgetLineChart::selectImageBackground(){
    ...
    _currentTemp->setBgImage(fileName);
...
void WidgetLineChart::selectImageAxisBackground(){
    QString fileName = QFileDialog::getOpenFileName(this, tr("Open File"),
                                                    "",
                                                    tr("Image Files (*.png *.jpg *.bmp *.gif *.jpeg *.png *.pbm *.pgm *.ppm *.tiff *.xbm *.xpm)"));
    _currentTemp->setBgAxisImg(fileName);
    QPixmap pixmap1(fileName);
    QPalette p = palette();
...
void WidgetLineChart::changeLegendColor(){
    ...
    if (selectedColor.isValid()){
        _currentTemp->setBgLegendColour(selectedColor);
...
void WidgetLineChart::changeColorLine(){
    ...
    if (selectedColor.isValid()){
        _currentTemp->setGraphColour(selectedColor);
        QPen newPenColor;
...
void WidgetLineChart::changeAxisColor(){
    ...
    if (selectedColor.isValid()){
        _currentTemp->setBgAxisColour(selectedColor);
        QPen newPenColor;
        newPenColor.setWidth(4);
        newPenColor.setColor(selectedColor);
...
void WidgetLineChart::changeBackgroundColor(){
    ...
    QColor selectedColor = colordialog->getColor(Qt::transparent, this);
    if (selectedColor.isValid()){
        _currentTemp->setBgColour(selectedColor);
        QPen newPenColor;
        newPenColor.setWidth(4);
        newPenColor.setColor(selectedColor);
...
void WidgetLineChart::moveLegend()
{
  ...
  if (QAction* contextAction = qobject_cast<QAction*>(sender()))
  {
    ...
    if (ok)
    {
      _currentTemp->setLegendPos(dataInt);
...
/**
 * @brief Draw a line representing the average
 */
...
/**
 * @brief WidgetLineChart::setImageBackground set graph bg image
 * @param path path to the image
 */
void WidgetLineChart::setImageBackground(const QString &path)
{
...
/**
 * @brief WidgetLineChart::setBGAxisImage set bg axis image
 * @param path path to the image
 */
void WidgetLineChart::setBGAxisImage(const QString &path)
{
    QPixmap pixmap1(path);
    QPalette p = palette();
...
/**
 * @brief WidgetLineChart::setBGColour set graph bg colour
 * @param col the colour
 */
void WidgetLineChart::setBGColour(const QColor &col)
{
    ui->widgetLineChart_2->setBackground(QBrush(col));
    ui->widgetLineChart_2->replot();
}
/**
 * @brief WidgetLineChart::setAxisBGColor set axis background colour
 * @param col the colour
 */
void WidgetLineChart::setAxisBGColor(const QColor &col)
{
    ui->widgetLineChart_2->axisRect()->setBackground(QBrush(col));
    ui->widgetLineChart_2->replot();
}

/**
 * @brief WidgetLineChart::setLegendColor set the legend colour
 * @param col the colour
 */
void WidgetLineChart::setLegendColor(const QColor &col)
{
    ui->widgetLineChart_2->legend->setBrush(QBrush(col));
    ui->widgetLineChart_2->replot();
}
/**
 * @brief WidgetLineChart::setLegendPos set the position of the legend
 * @param pos the position
 */
void WidgetLineChart::setLegendPos(const int &pos)
{
    ui->widgetLineChart_2->axisRect()->insetLayout()->setInsetAlignment(0, (Qt::Alignment)pos);
    ui->widgetLineChart_2->replot();
}
...
/**
 * @author Jen Stewart
 *  @brief Function to save the Line Chart as an image file
 *
 */
...
/**
 * @brief WidgetLineChart::on_pushButtonLoadTemp_clicked load a template
 */
void WidgetLineChart::on_pushButtonLoadTemp_clicked()
{
    QString fileName = QFileDialog::getOpenFileName(this, tr("Open File"),
                                                    "",
...
/**
 * @brief WidgetLineChart::on_pushButtonSaveTemp_clicked save a template
 */
void WidgetLineChart::on_pushButtonSaveTemp_clicked()
{
