/**
  ...
  Allows loading the data structure from the database and saving templates.
...
/**
 * @brief FilterData::FilterData Default constructor
 * Takes data from the database and creates the rest of the data objects.
 * Uses default data.
 */
...
/**
 * @brief FilterData::addYear Add a year object to the data structure
 * @param skey service id key
 * @param mkey measure id key
 * @param mukey municipality key
 * @param year name of the year to add
 */
 ...
 * @brief FilterData::parseMeasure Parse data from database into data structure
 * @param mID measureID tag that needs parsing to obtain the right data from the database.
 * @param sID serviceID tag to allow the data to be placed correctly in the data structure.
 */
...
/**
 * @brief FilterData::serviceList obtain the service list
...
/**
 * @brief FilterData::serviceNameList obtain the service name list
 * @return a QMap containing the service name and service id.
 */
